...
<section class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <button @click="loadUsage(); loadUsageDaily()"
            ...
            <span x-text="t('refresh')" class="hidden sm:inline">Refresh</span>
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8" x-show="loadingUsage">
        ...
        <div class="flex flex-col bg-neuBg shadow-[8px_8px_16px_#a3b1c6,-8px_-8px_16px_#ffffff] rounded-3xl p-6 md:p-8 animate-pulse">
            ...
            <div class="flex-1 flex items-end justify-between space-x-4 bg-neuBg shadow-[inset_4px_4px_8px_#a3b1c6,inset_-4px_-4px_8px_#ffffff] rounded-2xl p-4" style="height: 180px;">
                <div class="w-1/6 bg-gray-300 rounded-t-lg h-[25%]"></div>
                <div class="w-1/6 bg-gray-300 rounded-t-lg h-[50%]"></div>
                <div class="w-1/6 bg-gray-300 rounded-t-lg h-[33%]"></div>
                <div class="w-1/6 bg-gray-300 rounded-t-lg h-[75%]"></div>
                <div class="w-1/6 bg-gray-300 rounded-t-lg h-[50%]"></div>
            </div>
            <div class="mt-6 flex items-center justify-between">
                <div class="h-8 bg-gray-300 rounded-xl w-1/3"></div>
                <div class="h-8 bg-gray-300 rounded-xl w-1/3"></div>
            </div>
        </div>
        <!-- Skeleton Card Kanan -->
