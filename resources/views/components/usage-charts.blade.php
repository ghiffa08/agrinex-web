...
<section class="space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
        ...
        <button @click="loadUsage(); loadUsageDaily()"
            class="bg-white/70 hover:bg-white dark:bg-slate-800/60 dark:hover:bg-slate-700 text-secondary dark:text-slate-200 px-4 py-2 rounded-full transition-all shadow-sm font-medium text-xs border border-white/50 dark:border-white/10" x-text="t('refresh')">Refresh</button>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" x-show="loadingUsage">
        ...
        <div class="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col">
            ...
            <div class="flex-1 flex items-end justify-between space-x-2" style="height: 140px;">
                <div class="w-1/6 bg-gray-200 dark:bg-slate-700 rounded-t h-1/4"></div>
                <div class="w-1/6 bg-gray-200 dark:bg-slate-700 rounded-t h-2/4"></div>
                <div class="w-1/6 bg-gray-200 dark:bg-slate-700 rounded-t h-1/3"></div>
                <div class="w-1/6 bg-gray-200 dark:bg-slate-700 rounded-t h-3/4"></div>
                <div class="w-1/6 bg-gray-200 dark:bg-slate-700 rounded-t h-1/2"></div>
            </div>
        </div>
        <!-- Skeleton Card Kanan -->
        <div class="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col">
