        ...
        <div class="hidden md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 pb-4">
            <template x-for="i in 5">
                <div class="w-full card !p-0 !rounded-3xl overflow-hidden animate-pulse flex flex-col">
                    <div class="h-36 bg-gray-200 dark:bg-slate-700"></div>
        ...
        <template x-for="(device, index) in devices" :key="device.id">
            <div class="min-w-[240px] md:min-w-0 md:w-full w-[240px] card !p-0 !rounded-3xl overflow-hidden snap-center flex-shrink-0 flex flex-col transition-all duration-300 cursor-pointer hover:-translate-y-1" @click="selectedDevice = device; showDeviceModal = true">
                ...
                <div class="h-36 relative bg-gray-100">
                    ...
                    <div class="w-full h-full bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/40 dark:to-emerald-800/20 flex items-center justify-center">
                        <svg class="w-12 h-12 text-emerald-300 dark:text-emerald-700/50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
                    
                    <!-- Status Badge -->
                    <div class="absolute top-3 left-3 bg-black/40 text-white text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-1.5">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-3 flex justify-between items-center">
                        <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-900/30 px-2 py-1 rounded" x-show="device.soil_moisture_pct !== null" x-text="'Moisture: ' + device.soil_moisture_pct + '%'"></span>
                    </div>
                </div>
            </div>
        </template>
