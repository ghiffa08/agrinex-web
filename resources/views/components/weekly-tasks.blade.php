<div class="mt-6 grid md:grid-cols-2 gap-6" x-show="weekViewDays.length">
    ...
    <div class="card flex flex-col gap-4">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <!-- Skeleton Load 24h -->
            <div x-show="loadingAll" class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <!-- 24h Forecast -->
            <div x-show="forecastView==='24h' && !loadingAll" style="display: none;" class="grid grid-cols-2 sm:grid-cols-4 gap-3" x-cloak>
    ...
    <div class="card flex flex-col gap-4">
        <div class="flex items-center justify-between">
            ...
            <button class="text-gray-400 hover:text-gray-600 transition" @click="refreshTasks()">
        ...
        <!-- Skeleton Load Tasks -->
        <div x-show="loadingAll" class="space-y-3">
            <template x-for="i in 2">
                <div class="flex gap-3 items-stretch animate-pulse">
                    <div class="w-12 h-12 shrink-0 rounded-md bg-gray-200"></div>
                    <div class="flex-1 bg-white border border-gray-100 rounded-md px-3 py-2 shadow-sm space-y-2">
        ...
        <div x-show="!loadingAll" style="display: none;" class="space-y-3">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-1">
                <button class="px-2 py-1 rounded bg-gray-100 hover:bg-gray-200 transition text-gray-600"
