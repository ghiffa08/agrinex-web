...
<div
    ...
    class="fixed inset-0 z-40 bg-black/25 backdrop-blur-[2px] md:hidden"
    x-cloak
></div>
...
>
    ...
    <div class="flex items-center justify-center h-14 flex-shrink-0">
        <a href="/"
           class="flex items-center justify-center w-10 h-10 rounded-2xl
                  ...
                  shadow-md shadow-emerald-200/50 dark:shadow-emerald-900/40
    ...
    {{-- Hairline divider --}}
    <div class="mx-3.5 h-px bg-black/6 dark:bg-white/8 flex-shrink-0"></div>
